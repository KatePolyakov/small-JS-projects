...
const birtDate = inventors.sort((firstYear, lastYear) => (firstYear.year > lastYear.year ? 1 : -1));
...
console.log('4. How many years did all the inventors live all together? ', allYears);
...
const alpha = people.sort((lastOne, newOne) => {
